            ...
            <div class="row">
              <div class="col l4 s12">
                ...
                <ul>
                  ...
                  <li><a class="grey-text text-lighten-3" href="https://www.linkedin.com/edu/instituto-tecnol%C3%B3gico-de-morelia-173011" target="_blank"><img src="Imagenes/link.png"> Linkedin</a></li>
                </ul>
              </div>
              <div class="col l4 s12">
    ...
    <body >
        ...
        <div style="text-align: justify;">
         <ol type="numeric">    
            ...
            <p><li>Aplica herramientas matemáticas, computacionales y métodos experimentales en la solución de problemas para formular modelos, analizar procesos y elaborar prototipos mecánicos.</li><br />

            <li>Selecciona y emplea los materiales adecuados para: el diseño y fabricación de elementos mecánicos; o para su uso en instalaciones industriales con base en el conocimiento de sus propiedades.</li><br />

            <li>Gestiona proyectos de diseño, manufactura, diagnóstico, instalación, operación, control y mantenimiento, tanto de sistemas mecánicos como de sistemas de aprovechamiento de fuentes de energía renovables y no renovables.</li> <br />

            <li>Participa en servicios de asesoría, peritaje, certificación, capacitación, selección tanto de equipo como maquinarias afines a su profesión. </li><br />

            <li>Elabora, interpreta y comunica eficazmente en su desempeño profesional en forma oral, escrita y gráfica: informes, propuestas, análisis y resultados de ingeniería en al menos dos idiomas. </li><br />

            <li>Posee capacidad directiva para administrar eficientemente los recursos humanos, materiales y económicos a su disposición en el ejercicio de su profesión. </li><br />

            <li>Desarrolla una actitud emprendedora para la creación de nuevas empresas, con espíritu creativo, liderazgo y compromiso social. </li><br />

            <li>Utiliza el pensamiento crítico en el análisis de situaciones relacionadas con la ingeniería mecánica, para la toma de decisiones de forma objetiva. </li><br />
            ...
            <li>Observa y aplica las normas y especificaciones nacionales e internacionales relacionadas con el tratamiento adecuado de las materias primas, los productos terminados, así como los materiales residuales, generados en los procesos industriales con el fin de preservar la integridad del ser humano y el medio ambiente. </li><br />

            <li>Participa en proyectos tecnológicos y de investigación científica encaminados a la conservación del medio ambiente fomentando un desarrollo sustentable. </li><br />

            <li>Implementa sistemas de control automático de procesos industriales y gestiona sistemas de calidad para mejorar los estándares de producción. </li><br />

            <li>Aplica sus conocimientos, habilidades y aptitudes para cursar estudios de posgrado. </li><br />

            <li>Reflexiona acerca del contexto histórico, geográfico y socioeconómico de su región, para proponer soluciones congruentes con la realidad del país en un entorno globalizado. </li><br /><br />
        ...
        <!--//// Se inserta la imagen de cabcera de a carrera [SE CAMBIARÁ POR UNA DEL MISMO TAMAÑO QUE LA DE MECÁNICA] -->
        <div class="divider"></div> 
        <img class="responsive-img materialboxed col s10 m10 l10 offset-l1 offset-m1 offset-s1" src="Imagenes/cabecera_tronica.png">
        <div class="divider"></div> 
        <br />
        ...
        <p><li>Ejerce su profesión legal y responsablemente para cumplir con las normas nacionales e internacionales que apliquen. </li><br />

        <li>Analiza, sintetiza, diseña, simula, construye e innova productos, procesos, equipos y sistemas mecatrónicos, para impactar positivamente en su entorno con una actitud investigadora, de acuerdo a las necesidades tecnológicas, sociales actuales y emergentes. </li><br />

        <li>Instala, opera, optimiza, controla y mantiene sistemas mecatrónicos integrando tecnologías mecánicas, eléctricas, electrónicas y herramientas computacionales.</li><br />

        <li>Planifica, evalúa, genera, administra y transfiere proyectos industriales y de carácter social para el desarrollo tecnológico del país. </li><br />
        ...
        <li>Interpreta información técnica de las áreas que componen la Ingeniería Mecatrónica para la transferencia, adaptación, asimilación e innovación de tecnologías de vanguardia. </li><br />
        </p><br />
          ...
          <div class="container">
            <div class="row">
              <div class="col l4 s12">
                <h5 class="white-text">Redes Sociales</h5>
                <ul>
                  <li><a class="grey-text text-lighten-3" href="https://www.facebook.com/IGE-ITMorelia-Oficial-137692846975721/" target="_blank"><img src="Imagenes/facebook.png"> Facebook</a></li>
                  <li><a class="grey-text text-lighten-3" href="https://twitter.com/itmoficial" target="_blank"> <img src="Imagenes/twitter.png"> Twitter</a></li>
                  <li><a class="grey-text text-lighten-3" href="https://www.youtube.com/user/ITMoreliaOficial/" target="_blank"> <img src="Imagenes/youtube.png"> Youtube</a></li>
                  <li><a class="grey-text text-lighten-3" href="https://www.linkedin.com/edu/instituto-tecnol%C3%B3gico-de-morelia-173011" target="_blank"><img src="Imagenes/linkedin.png"> Linkedin</a></li>
                </ul>
              </div>
              <div class="col l4 s12">
                <h5 class="white-text">Vínculos Académicos</h5>
