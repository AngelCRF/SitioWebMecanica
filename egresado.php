...
<html lang="es">
    <head>
        ...
        <meta charset="utf-8"/>
        <meta name="keywords" content="perfiles de egresado de Metal-Mecánica"/>
    ...
    <body>
        ...
        <div>
            <h4 class="center-align">Perfil de Egreso</h4>
        </div>
          ...
          <ol type="numeric">    
            ...
            <div class="row">
                <div class="col s12 m12 l4">
                    <div class="card small #03a9f4 light-blue">
                        <div class="card-content white-text">
                            <p><li>Ejerce su profesión legal y responsablemente para cumplir con las normas nacionales e internacionales que apliquen. </li></p><br /><br /><br /><br />
                            <div class="center-align">
                                <i class="small material-icons" >gavel</i>
                            </div>
                        </div>
