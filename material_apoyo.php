...
<html lang="es">
    ...
    <br><br>
    	<ul class="nav">            
            ...
            <li><a href="material_apoyo.php#"><font color="white">RETICULA</font></a>
            	<ul>
            ...
            <li><a href="material_apoyo.php#"><font color="white">PERFILES</font></a>
                <ul>
          ...
          <li><a href="material_apoyo.php#"><font color="white">INDICE DE REPROBACIÓN</font></a>
                <ul>
...
<div class="numero1">
<bR>
<div class="lcombo1">&nbsp;&nbsp;&nbsp;Documentación<br><br></div>
     
     
     
    <div class="lcombo2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Docentes</div><br>
    <div class="docu">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><form>
    ...
    <div class="docu1"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> <form>
          <select id="Lista" name=" Lista" class="combo"   onchange="window.open(this.options[this.selectedIndex].value,'_blank')" style="width: 100px;" >
         <option  selected>Normativos</option>
     ...
     <div class="lcombo2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alumnos </div><br>
    <div class="docu2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
<select id="Lista" name=" Lista" class="combo" onchange="window.open(this.options[this.selectedIndex].value,'_blank')">
        ...
        <div class="numero2">
<br>
<div class="lcombo1"><center>Material de Apoyo</center><br><br></div>
