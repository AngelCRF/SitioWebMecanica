...
<html lang="es">
    <head>
        <title>ITMORELIA| Ing. en Gesti贸n Empresarial</title>
        <meta charset="utf-8"/>
...
<div>   
    ...
    <div  style = "float: left; height: 100px; width: 100px;">
    	...
    	<ul class="titulo_carrera">
			<li>Ingenieria en Gesti贸n Empresarial</li>    	
    	</ul>
    ...
    <br><br>
    	<ul class="nav">            
          ...
          <li><a href="index.php#"><font color="white">INDICE DE REPROBACI脫N</font></a>
                <ul>
...
<div class="sitios_interes2"><center>Sitios de Inter茅s</center><br></div>
...
<td><a title="Medio informativo especializado sobre los 鷏timos desarrollos tecnol骻icos e innovadores de nuestro pa韘." href="http://www.conacytprensa.mx/" target="_blank"><img src="Pagina/images/logoAICgris.png"></a></td>
...
<td><a title="S鷅ete a un autobus, concibe, construye e inicia una Startup" href="https://northamerica.startupbus.com/buses/mex.html" target="_blank"><img src="Imagenes/startupbusMexico.png"></a></td>
...
<div class="CVinculo">
<div class="titulos_pie">V铆nculos Acad茅micos</center><br><br></div>
<a  id="link" href="http://www.tecnm.mx/" target="_blank">Tecnol贸gico Nacional De M茅xico<br><br></a>
...
<a     id="link" href="http://www.conacyt.mx/" target="_blank">Consejo Nacional De Ciencia Y Tecnolog铆a<br><br></a>
</div>
<div class="CContactar">
<div class="titulos_pie">Contactanos</div><br><br>
<a id="link2">Tel茅fonos:</a><br>
4433121570 Ext.248<br><br>
<a id="link2">Email:</a><br><a id="link" >ige@itmorelia.edu.mx</a><br><br>
<a id="link2">Direcci贸n:</a><br>
Avenida Tecnol贸gico No. 1500. Lomas de Santiaguito, Edificio AA. C.P. 58120 Morelia, Michoac谩n, M茅xico.<br>
</div> 

</div>
Derechos Reservados. 漏 2017 Instituto Tecnol贸gico de Morelia.
</div>
